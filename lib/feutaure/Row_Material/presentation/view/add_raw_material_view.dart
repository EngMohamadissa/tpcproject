// lib/presentation/pages/add_raw_material_page.dart
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError
            ? Palette.primary
            : Palette.primary, // استخدم Palette.success للنجاح
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed:
                        state is AddRawMaterialLoading ? null : _addRawMaterial,
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          Palette.primary, // Button background color
