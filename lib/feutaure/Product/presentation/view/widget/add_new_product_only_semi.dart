...
import 'package:tcp/feutaure/Product/presentation/view/manager/add_cubit/add_product_cubit.dart';
import 'package:tcp/feutaure/Product/presentation/view/manager/add_cubit/add_product_state.dart';
...
import 'package:tcp/feutaure/simi_products/data/model/simi_product_model.dart';
...
class _AddNewProductOnlySemiBodyState extends State<AddNewProductOnlySemiBody> {
  ...
  final List<MaterialComponent> _materials = [
    MaterialComponent(),
  ];
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                flex: 4,
                                child:
                                    DropdownButtonFormField<SimiProductModel>(
                                  value: component.selectedMaterial,
                                  decoration: const InputDecoration(
                                    labelText: 'المادة',
                                    border: OutlineInputBorder(),
                                  ),
